package com.example.goldmedal.controller;

import com.example.goldmedal.model.*;
import com.example.goldmedal.repositories.CountryRepository;
import com.example.goldmedal.repositories.GoldMedalRepository;
...
public class GoldMedalController {
    ...
    private CountryDetailsResponse getCountryDetailsResponse(String countryName) {
        ...
        var numberEventsWonByFemaleAthletes = goldMedalRepository.countByCountryAndGender(countryName, "Female");
        var numberEventsWonByMaleAthletes = goldMedalRepository.countByCountryAndGender(countryName, "Male");
